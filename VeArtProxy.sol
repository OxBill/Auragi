...
contract VeArtProxy is IVeArtProxy {
    ...
    function _tokenURI(uint _tokenId, uint _lock_amount, uint _locked_end, uint _vote_power) external pure returns (string memory output) {
        output = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 900"><style>.b{fill:#b3d9ff;}.g{fill:#D3F85A;}.f{fill:#000066;}.w{fill:#f2f2f2;}.s{font-size:37px;}</style><rect fill="#fff4f3" width="600" height="900"/><rect class="b" x="0" y="424" width="600" height="98"/><rect class="b" x="0" y="544" width="600" height="98"/><rect class="b" x="0" y="772" width="600" height="98"/><rect class="b" x="0" y="658" width="600" height="98"/>';
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "veAURI #', toString(_tokenId), '", "description": "Auriga locks, can be used to vote on token emission, and receive bribes, fees", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
