...
/// @title Voting Escrow
/// @notice veAGI implementation that escrows ERC-20 tokens in the form of an ERC-721 NFT
...
contract VotingEscrow is IERC721, IERC721Metadata, IVotes {
    ...
    /// @param token_addr `AURI` token address
    ...
    string constant public name = "veAGI";
    string constant public symbol = "veAGI";
